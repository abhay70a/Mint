...
interface BorderGlowProps {
  ...
  className?: string
  style?: CSSProperties
  /** Style applied to the inner content wrapper (flex column by default) */
...
function parseHSL(hslStr: string): { h: number; s: number; l: number } {
  ...
  if (!match) return { h: 145, s: 100, l: 50 }
...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  const wrapperStyle: CSSProperties = {
    ...
    boxShadow: 'rgba(0,0,0,0.1) 0 1px 2px, rgba(0,0,0,0.12) 0 4px 8px, rgba(0,0,0,0.15) 0 8px 16px',
    ...style,
  }
